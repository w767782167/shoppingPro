...
<div class="take-delivery">
 <div class="status">
   ...
   <div class="successInfo">
     <ul>
       <li>待付款金额<em>¥${sessionScope.SESSION_IN_TOTALPRICE}</em></li>
       <div class="user-info">
         <p>收货人：${sessionScope.SESSION_IN_SIGNAME}</p>
         <p>联系电话：${sessionScope.SESSION_IN_TEL}</p>
         <p>收货地址：${sessionScope.SESSION_IN_ADRESS1}</p>
       </div>
