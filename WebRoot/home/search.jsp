		...
		<div class="am-container header">
			...
			<ul class="message-r">
				...
				<div class="topMessage my-shangcheng">
					<div class="menu-hd MyShangcheng"><c:choose>
							<c:when test="${USER_IN_SESSION!=null}">
			...
			<div class="nav white">
				...
				<div class="search-bar pr">
					...
					<form action="${url}/search" method="post"><!-- -------提交到sevlet处理搜索 -->
	                  	...
	                  	<div class="theme-popover">														
							...
							<div class="search-content">
								<div class="sort">
									...
									<li><a title="价格" href="${url}/search?cmd=sortPrice">价格优先</a></li>
								...
								<!-- 一个商品信息模板 -->
									...
									<li>
										<div class="i-pic limit">
											<div id="imgsize">
											<!-- 显示图片详细信息 -->
										<a href="${url}/intrServlet?goodId=${goods.id}"><img src="${goods.path}"/></a>
										<%-- <a href="${url}/intrServlet?goodId=${goods.id}"><img src="E:/tomcat/apache-tomcat-7.0.57-windows-x64/apache-tomcat-7.0.57/webapps/shoppingPro/images/01.jpg"/></a> --%> 
											</div>										
							...
							<div class="clear"></div>
							<!--分页 -->
							<form action="${url}/search" id="advanceForm" method="post">
