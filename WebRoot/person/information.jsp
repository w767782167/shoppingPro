			...
			<div class="main-wrap">
				...
				<div class="user-info">
					...
					<div class="user-infoPic">
						...
						<div class="info-m">
							<div>
								<b>用户名：<i>${USER_IN_SESSION.username}</i>
								</b>
							</div>
							<div class="u-level">
		...
		<aside class="menu">
			<ul>
				...
				<li class="person"><a href="#">个人资料</a>
					<ul>
						<li class="active"><a href="information.jsp">个人信息</a>
						</li>
						<li><a href="safety.jsp">安全设置</a>
						</li>
						<li><a href="address.jsp">收货地址</a>
						</li>
					</ul></li>
				<li class="person"><a href="#">我的交易</a>
					<ul>
						<!-- <li><a href="/shoppingPro/privateorder">订单管理</a></li> -->
						<li><a href="/shoppingPro/privateorder">订单管理</a>
						</li>
				...
				<li class="person"><a href="#">我的资产</a>
					<ul>
						...
						<li><a href="bill.jsp">账单明细</a>
						</li>
					</ul></li>

				<li class="person"><a href="#">我的小窝</a>
					<ul>
						<li><a href="collection.jsp">收藏</a>
						</li>
						<li><a href="foot.jsp">足迹</a>
						</li>
						<li><a href="comment.jsp">评价</a>
						</li>
						<li><a href="news.jsp">消息</a>
						</li>
					</ul></li>
